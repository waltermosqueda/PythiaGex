    ...
    public class GammaHoy : Indicator
    {
        ...
        protected override void OnInitialize()
        {
            ...
            if (Fuente == FuenteDatos.Archivo)
            {
                ...
                Log("Gamma Hoy 1.8e arranca en REBOBINADO. raiz=" + Raiz() + " horizonte=" + Horizonte + " carpeta=" + Feed.Archivo.Carpeta);
                return;
            }
            SubscribeToTimer(_periodo, _tick);
            _ = Reloj.Medir(Log);
            ...
            _ = BajarFeed();
            if (UsarCadenaViva) ArrancarViva();
            Log("Gamma Hoy 1.8e arranca" + (Fuente == FuenteDatos.Hibrido ? " en HIBRIDO (archivo + vivo)" : " en VIVO (con el pasado del archivo)") + ". raiz=" + Raiz() + " horizonte=" + Horizonte);
        }
