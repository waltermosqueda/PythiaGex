...
**Actualización 2026-09-06:** versión **8.0.14.398-latest** vista en pantalla. Servidor E2/R2 según la sesión.

**Actualizado 2026-09-10:** ATAS se actualizo solo a **8.0.14.399** el 09-09 a las 11:08 (DLLs en Program Files con esa fecha). Con esa version la cadena viva de Rithmic dejo de encontrar el conector (CadenaViva.Rastrear a 3 niveles); 1.8c busca mas hondo y en estaticos. La PC tiene 16 GB y ATAS usa 7-9 GB: con Edge y la app del chat queda sin RAM y se 'tilda'; el indicador ahora poda los perfiles viejos (~1 GB menos).
